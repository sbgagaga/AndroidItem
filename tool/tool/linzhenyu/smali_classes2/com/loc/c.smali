...
.method public static a(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)I
    ...
    new-instance v6, Lcom/amap/api/fence/GeoFence;

    invoke-direct {v6}, Lcom/amap/api/fence/GeoFence;-><init>()V

    new-instance v7, Lcom/amap/api/fence/PoiItem;

    invoke-direct {v7}, Lcom/amap/api/fence/PoiItem;-><init>()V
    ...
    invoke-virtual {v7, v9}, Lcom/amap/api/fence/PoiItem;->setPoiId(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v9}, Lcom/amap/api/fence/PoiItem;->setPoiName(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v9}, Lcom/amap/api/fence/PoiItem;->setPoiType(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v9}, Lcom/amap/api/fence/PoiItem;->setTypeCode(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v9}, Lcom/amap/api/fence/PoiItem;->setAddress(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v10, v11}, Lcom/amap/api/fence/PoiItem;->setLongitude(D)V
    ...
    invoke-virtual {v7, v9, v10}, Lcom/amap/api/fence/PoiItem;->setLatitude(D)V
    ...
    invoke-virtual {v7}, Lcom/amap/api/fence/PoiItem;->getLatitude()D

    move-result-wide v12

    invoke-virtual {v7}, Lcom/amap/api/fence/PoiItem;->getLongitude()D
    ...
    invoke-virtual {v6, v9}, Lcom/amap/api/fence/GeoFence;->setPointList(Ljava/util/List;)V

    invoke-virtual {v6, v11}, Lcom/amap/api/fence/GeoFence;->setCenter(Lcom/amap/api/location/DPoint;)V
    ...
    invoke-virtual {v7, v9}, Lcom/amap/api/fence/PoiItem;->setTel(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v9}, Lcom/amap/api/fence/PoiItem;->setProvince(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v9}, Lcom/amap/api/fence/PoiItem;->setCity(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8}, Lcom/amap/api/fence/PoiItem;->setAdname(Ljava/lang/String;)V

    invoke-virtual {v6, v7}, Lcom/amap/api/fence/GeoFence;->setPoiItem(Lcom/amap/api/fence/PoiItem;)V
    ...
    invoke-virtual {v6, v7}, Lcom/amap/api/fence/GeoFence;->setFenceId(Ljava/lang/String;)V

    const-string v7, "customId"

    invoke-virtual {v0, v7}, Landroid/os/Bundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/amap/api/fence/GeoFence;->setCustomId(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v7}, Lcom/amap/api/fence/GeoFence;->setPendingIntentAction(Ljava/lang/String;)V

    const/4 v7, 0x2

    invoke-virtual {v6, v7}, Lcom/amap/api/fence/GeoFence;->setType(I)V
    ...
    invoke-virtual {v6, v7}, Lcom/amap/api/fence/GeoFence;->setRadius(F)V
    ...
    invoke-virtual {v6, v7, v8}, Lcom/amap/api/fence/GeoFence;->setExpiration(J)V
    ...
    invoke-virtual {v6, v7}, Lcom/amap/api/fence/GeoFence;->setActivatesAction(I)V
...
.method public static declared-synchronized a()J
    ...
    sget-wide v3, Lcom/loc/c;->a:J

    cmp-long v5, v1, v3

    if-lez v5, :cond_0

    sput-wide v1, Lcom/loc/c;->a:J

    goto :goto_0

    :cond_0
    sget-wide v1, Lcom/loc/c;->a:J
...
.method private a(Ljava/util/List;F)Ljava/util/List;
    ...
    invoke-direct {v0, v7, v8, v4, v5}, Lcom/amap/api/location/DPoint;-><init>(DD)V

    invoke-static {v15, v0}, Lcom/loc/et;->a(Lcom/amap/api/location/DPoint;Lcom/amap/api/location/DPoint;)F
    ...
    invoke-direct {v4, v0, v2}, Lcom/loc/c;->a(Ljava/util/List;F)Ljava/util/List;
    ...
    invoke-direct {v4, v1, v2}, Lcom/loc/c;->a(Ljava/util/List;F)Ljava/util/List;
...
.method public final b(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)I
    ...
    :try_start_2
    invoke-direct {v3, v6, v5}, Lcom/loc/c;->a(Ljava/util/List;F)Ljava/util/List;
    ...
    invoke-static {v4, v6}, Lcom/loc/a;->b(Lcom/amap/api/location/DPoint;Ljava/util/List;)F
    ...
    invoke-static {v4, v6}, Lcom/loc/a;->a(Lcom/amap/api/location/DPoint;Ljava/util/List;)F
