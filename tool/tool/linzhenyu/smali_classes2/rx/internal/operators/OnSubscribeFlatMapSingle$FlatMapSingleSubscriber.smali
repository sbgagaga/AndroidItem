...
.method drain()V
    ...
    .line 190
    iget-object v0, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->wip:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 195
    :cond_0
    iget-object v0, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->actual:Lrx/Subscriber;

    .line 196
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->queue:Ljava/util/Queue;

    .line 197
    iget-boolean v2, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->delayErrors:Z

    .line 198
    iget-object v3, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->active:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 201
    :cond_1
    iget-object v6, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->requested:Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber$Requested;

    invoke-virtual {v6}, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber$Requested;->get()J
    ...
    .line 205
    iget-boolean v12, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->cancelled:Z
    ...
    .line 210
    :cond_2
    iget-boolean v12, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->done:Z
    ...
    .line 213
    iget-object v13, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->errors:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 216
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->errors:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 245
    iget-boolean v6, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->cancelled:Z
    ...
    .line 250
    :cond_9
    iget-boolean v6, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->done:Z
    ...
    .line 262
    :cond_b
    iget-object v6, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->errors:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v6, v10, v11}, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber$Requested;->produced(J)V
    ...
    iget v6, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->maxConcurrency:I
    ...
    .line 279
    invoke-virtual {p0, v10, v11}, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->request(J)V

    .line 283
    :cond_e
    iget-object v6, p0, Lrx/internal/operators/OnSubscribeFlatMapSingle$FlatMapSingleSubscriber;->wip:Ljava/util/concurrent/atomic/AtomicInteger;
