...
# instance fields
.field a:Lcom/amap/api/mapcore/util/de;

.field private b:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lcom/amap/api/mapcore/util/av;",
            ">;"
        }
    .end annotation
.end field
...
.method public constructor <init>(Lcom/autonavi/base/amap/api/mapcore/IAMapDelegate;)V
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/util/ax;->b:Ljava/util/List;

    .line 39
    iput-object p1, p0, Lcom/amap/api/mapcore/util/ax;->d:Lcom/autonavi/base/amap/api/mapcore/IAMapDelegate;

    return-void
.end method

.method private a(Lcom/amap/api/mapcore/util/av;)V
    .locals 2
    ...
    .line 110
    iget-object v0, p0, Lcom/amap/api/mapcore/util/ax;->b:Ljava/util/List;

    monitor-enter v0

    .line 111
    :try_start_0
    iget-object v1, p0, Lcom/amap/api/mapcore/util/ax;->b:Ljava/util/List;
...
# virtual methods
.method public a()Lcom/amap/api/mapcore/util/de;
    .locals 1

    .line 51
    iget-object v0, p0, Lcom/amap/api/mapcore/util/ax;->d:Lcom/autonavi/base/amap/api/mapcore/IAMapDelegate;

    invoke-interface {v0}, Lcom/autonavi/base/amap/api/mapcore/IAMapDelegate;->getGLShaderManager()Lcom/amap/api/mapcore/util/de;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/mapcore/util/ax;->a:Lcom/amap/api/mapcore/util/de;

    .line 52
    iget-object v0, p0, Lcom/amap/api/mapcore/util/ax;->a:Lcom/amap/api/mapcore/util/de;
...
.method public declared-synchronized a(Lcom/amap/api/maps/model/MultiPointOverlayOptions;)Lcom/autonavi/amap/mapcore/interfaces/IMultiPointOverlay;
    ...
    invoke-direct {v0, p1, p0}, Lcom/amap/api/mapcore/util/aw;-><init>(Lcom/amap/api/maps/model/MultiPointOverlayOptions;Lcom/amap/api/mapcore/util/ax;)V

    .line 103
    invoke-direct {p0, v0}, Lcom/amap/api/mapcore/util/ax;->a(Lcom/amap/api/mapcore/util/av;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public a(Lcom/amap/api/maps/AMap$OnMultiPointClickListener;)V
    ...
    .line 169
    iput-object p1, p0, Lcom/amap/api/mapcore/util/ax;->c:Lcom/amap/api/maps/AMap$OnMultiPointClickListener;
...
.method public a(Lcom/autonavi/base/amap/mapcore/MapConfig;[F[F)V
    ...
    check-cast v2, Lcom/amap/api/mapcore/util/av;

    .line 126
    invoke-interface {v2, p1, p2, p3}, Lcom/amap/api/mapcore/util/av;->a(Lcom/autonavi/base/amap/mapcore/MapConfig;[F[F)V
...
.method public a(Lcom/autonavi/amap/mapcore/IPoint;)Z
    ...
    .line 145
    iget-object v0, p0, Lcom/amap/api/mapcore/util/ax;->c:Lcom/amap/api/maps/AMap$OnMultiPointClickListener;
    ...
    .line 151
    :try_start_0
    iget-object v2, p0, Lcom/amap/api/mapcore/util/ax;->b:Ljava/util/List;
    ...
    .line 156
    iget-object p1, p0, Lcom/amap/api/mapcore/util/ax;->c:Lcom/amap/api/maps/AMap$OnMultiPointClickListener;
...
.method public declared-synchronized b()V
    ...
    .line 59
    :try_start_0
    iput-object v0, p0, Lcom/amap/api/mapcore/util/ax;->c:Lcom/amap/api/maps/AMap$OnMultiPointClickListener;
    :try_end_0
