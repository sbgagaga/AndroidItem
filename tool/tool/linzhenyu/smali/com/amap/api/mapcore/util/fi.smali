...
.field e:Lcom/amap/api/mapcore/util/lj;

.field f:Lcom/amap/api/mapcore/util/gn;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/util/fi;->b:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationManagerBase;

    iput-object v0, p0, Lcom/amap/api/mapcore/util/fi;->c:Ljava/lang/Object;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/amap/api/mapcore/util/fi;->d:Z

    iput-object v0, p0, Lcom/amap/api/mapcore/util/fi;->e:Lcom/amap/api/mapcore/util/lj;

    iput-object v0, p0, Lcom/amap/api/mapcore/util/fi;->f:Lcom/amap/api/mapcore/util/gn;

    :try_start_0
    invoke-static {}, Lcom/amap/api/mapcore/util/ls;->a()Lcom/amap/api/mapcore/util/gn;
    ...
    invoke-direct {v0}, Lcom/amap/api/mapcore/util/lj;-><init>()V
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/amap/api/mapcore/util/fi;->a:Landroid/content/Context;
    :try_end_0
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/util/fi;->a:Landroid/content/Context;
    ...
    :try_start_3
    iput-boolean p1, p0, Lcom/amap/api/mapcore/util/fi;->d:Z
    :try_end_3
    ...
    :cond_0
    :goto_1
    iget-boolean p1, p0, Lcom/amap/api/mapcore/util/fi;->d:Z
    ...
    iput-object p1, p0, Lcom/amap/api/mapcore/util/fi;->c:Ljava/lang/Object;

    return-void

    :cond_1
    iget-object p1, p0, Lcom/amap/api/mapcore/util/fi;->a:Landroid/content/Context;

    invoke-direct {p0, p1}, Lcom/amap/api/mapcore/util/fi;->b(Landroid/content/Context;)Lcom/autonavi/amap/mapcore/Inner_3dMap_locationManagerBase;

    move-result-object p1

    iput-object p1, p0, Lcom/amap/api/mapcore/util/fi;->b:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationManagerBase;
...
.method private b(Landroid/content/Context;)Lcom/autonavi/amap/mapcore/Inner_3dMap_locationManagerBase;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/amap/api/mapcore/util/fi;->f:Lcom/amap/api/mapcore/util/gn;
    ...
    const-class v3, Lcom/amap/api/mapcore/util/ll;
    ...
    invoke-static/range {v0 .. v5}, Lcom/amap/api/mapcore/util/ia;->a(Landroid/content/Context;Lcom/amap/api/mapcore/util/gn;Ljava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1}, Lcom/amap/api/mapcore/util/ll;-><init>(Landroid/content/Context;)V
...
.method public a()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/amap/api/mapcore/util/fi;->d:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/amap/api/mapcore/util/fi;->c:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, p0, Lcom/amap/api/mapcore/util/fi;->b:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationManagerBase;
...
.method public a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationListener;)V
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/util/fi;->e:Lcom/amap/api/mapcore/util/lj;

    iget-object v1, p0, Lcom/amap/api/mapcore/util/fi;->c:Ljava/lang/Object;

    invoke-virtual {v0, v1, p1}, Lcom/amap/api/mapcore/util/lj;->a(Ljava/lang/Object;Lcom/autonavi/amap/mapcore/Inner_3dMap_locationListener;)V
...
.method public a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V
    ...
    invoke-static {v0, p1}, Lcom/amap/api/mapcore/util/lj;->a(Ljava/lang/Object;Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V
