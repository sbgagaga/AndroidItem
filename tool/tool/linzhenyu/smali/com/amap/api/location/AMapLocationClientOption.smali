...
.field private C:Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/amap/api/location/AMapLocationClientOption;->A:Z
...
.method public constructor <init>()V
    ...
    iput v1, p0, Lcom/amap/api/location/AMapLocationClientOption;->B:F

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/amap/api/location/AMapLocationClientOption;->C:Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;
...
.method protected constructor <init>(Landroid/os/Parcel;)V
    ...
    iput v2, p0, Lcom/amap/api/location/AMapLocationClientOption;->B:F

    const/4 v2, 0x0

    iput-object v2, p0, Lcom/amap/api/location/AMapLocationClientOption;->C:Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;
    ...
    :goto_f
    sput-boolean v3, Lcom/amap/api/location/AMapLocationClientOption;->A:Z

    invoke-virtual {p1}, Landroid/os/Parcel;->readFloat()F

    move-result v3

    iput v3, p0, Lcom/amap/api/location/AMapLocationClientOption;->B:F
...
.method public static isDownloadCoordinateConvertLibrary()Z
    ...
    sget-boolean v0, Lcom/amap/api/location/AMapLocationClientOption;->A:Z
...
.method public static setDownloadCoordinateConvertLibrary(Z)V
    ...
    sput-boolean p0, Lcom/amap/api/location/AMapLocationClientOption;->A:Z
...
.method public clone()Lcom/amap/api/location/AMapLocationClientOption;
    ...
    iget v1, p0, Lcom/amap/api/location/AMapLocationClientOption;->B:F

    iput v1, v0, Lcom/amap/api/location/AMapLocationClientOption;->B:F

    iget-object v1, p0, Lcom/amap/api/location/AMapLocationClientOption;->C:Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;

    iput-object v1, v0, Lcom/amap/api/location/AMapLocationClientOption;->C:Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;
...
.method public getDeviceModeDistanceFilter()F
    ...
    iget v0, p0, Lcom/amap/api/location/AMapLocationClientOption;->B:F
...
.method public getLocationPurpose()Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;
    ...
    iget-object v0, p0, Lcom/amap/api/location/AMapLocationClientOption;->C:Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;
...
.method public setDeviceModeDistanceFilter(F)Lcom/amap/api/location/AMapLocationClientOption;
    ...
    iput p1, p0, Lcom/amap/api/location/AMapLocationClientOption;->B:F
...
.method public setLocationPurpose(Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;)Lcom/amap/api/location/AMapLocationClientOption;
    ...
    iput-object p1, p0, Lcom/amap/api/location/AMapLocationClientOption;->C:Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;
...
.method public setWifiScan(Z)Lcom/amap/api/location/AMapLocationClientOption;
    ...
    iget-boolean p1, p0, Lcom/amap/api/location/AMapLocationClientOption;->w:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/amap/api/location/AMapLocationClientOption;->C:Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p2}, Lcom/amap/api/location/AMapLocationClientOption$AMapLocationProtocol;->ordinal()I
    ...
    :cond_2
    invoke-virtual {p2}, Lcom/amap/api/location/AMapLocationClientOption$GeoLanguage;->ordinal()I
    ...
    sget-boolean p2, Lcom/amap/api/location/AMapLocationClientOption;->A:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeByte(B)V

    iget p2, p0, Lcom/amap/api/location/AMapLocationClientOption;->B:F

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeFloat(F)V

    iget-object p2, p0, Lcom/amap/api/location/AMapLocationClientOption;->C:Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;
    ...
    :cond_3
    invoke-virtual {p2}, Lcom/amap/api/location/AMapLocationClientOption$AMapLocationPurpose;->ordinal()I
